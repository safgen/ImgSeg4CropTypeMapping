...
def UNet(input_shape, NUM_CLASSES=1, dropout_rate=0.0, batch_norm=True):
    ...
    conv_final = layers.Activation('sigmoid')(conv_final)  #Change to softmax for multiclass
...
def Attention_UNet(input_shape, NUM_CLASSES=3, dropout_rate=0.0, batch_norm=True):
    ...
    conv_final = layers.Conv2D(NUM_CLASSES, kernel_size=(1,1))(up_conv_128)
    # conv_final = layers.BatchNormalization(axis=3)(conv_final)
    conv_final = layers.Activation('softmax')(conv_final)  #Change to softmax for multiclass
